...
function UserBlock({ data, updateUserDetails, onSelect }) {
  ...
  return (
    <div onClick={onSelect} className="w-full flex flex-col md:flex-row divide-y md:divide-y-0 md:divide-x divide-gray-600 bg-slate-950/75 backdrop-blur-md rounded-lg border-2 border-gray-600 border-opacity-50 p-4 justify-between my-4 gap-4 hover:border-[#00CBF0]">
      ...
      <div className="flex flex-col lg:flex-row justify-between pl-4 md:w-1/2 lg:w-full space-y-2 mt-4 ">
