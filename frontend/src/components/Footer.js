...
export default function Footer() {
  return (
    <footer className="bg-[#00011E] border-b-2 border-[#38C8F8] border-t border-opacity-70 flex flex-wrap items-center">
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            ...
            <div>
              ...
              <ul className="text-gray-400 font-medium">
                <li className="mb-4">
                  <Link href={'https://github.com/deepcytes'}>
                    Github
                  </Link>
                </li>
                <li className="mb-4">
                  <Link href={'https://www.deepcytes.io/'}>
                    Website
                  </Link>
                </li>
              </ul>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm t sm:text-center text-gray-400">
          ...
          <div className="flex mt-4 sm:justify-center sm:mt-0">
            ...
            >
              <div className="rounded-full bg-black p-2 hover:bg-blue-500">
            ...
            >
              <div className="rounded-full bg-black p-2 hover:bg-purple-500">
                <svg
                  className="w-6 h-6"
                  aria-hidden="true"
            ...
            <a
              ...
              className="text-gray-500 hover:text-white ms-5"
            >
              <div className="rounded-full bg-black p-2 hover:bg-gray-500">
                <svg
                  className="w-6 h-6"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <a href="https://www.deepcytes.io/" className="text-gray-500 hover:text-white ms-5">
              <div className="rounded-full bg-black p-2 hover:bg-pink-500">
                <svg
                  className="w-6 h-6"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
