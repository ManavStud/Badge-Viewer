...
useEffect(() => {
  ...
  return (
    <div className='w-full'>
      <form onSubmit={handleBadgeFormSubmit} className="flex flex-col w-5/6 mx-auto">
      <div className="flex flex-row">

        {/* Left: Badges List */}
        <div className="w-1/3 mr-2 bg-slate-800/60 rounded-lg p-2 border border-gray-700">
